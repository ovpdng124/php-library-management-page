...
<div class="container bg-primary" style="border-radius: 12px; color: wheat">
    <h2 class="my-3 text-center">Create a new card</h2>
    <form action="" method="post">
        <div class="row">
            ...
            <input type="text" class="my-1 col-8 form-control" name="cardID"
                   value="" placeholder="Card ID *" required maxlength="8">
        </div>
        <div class="row">
            ...
            <input type="text" class="my-1 col-8 form-control" name="studentName"
                   value="" placeholder="Student Name *" required>
        </div>
        <div class="row">
            ...
            <input type="text" class="my-1 col-8 form-control" name="address"
                   value=""  placeholder="e.g: 194B-Pasteur-Da Nang *" required>
        </div>
        <div class="row">
            ...
            <input type="tel" pattern="[0-9]{11}||[0-9]{10}" class="my-1 col-8 form-control" name="phoneNumber"
                   value="" placeholder="e.g 0905xxxxxx *" required maxlength="10" minlength="10">
        </div>
        <div class="row">
            <div style="width: 60%;">
                <button type="submit" class="float-right col-4 btn-primary rounded" style="color: wheat;" name="action" value="create_card"><b>Create</b>
                </button>
            </div>
            <div  style="width: 40%;">
            <button type="button" class="float-right mr-2 col-2 btn-primary rounded" style="color: wheat;"
